...
export const metadata: Metadata = {
  ...
  description: 'Eliminate repetitive manual work with custom workflow automation built around your existing tools and processes.',
  openGraph: {
    title: 'Workflow Automation | Pressense',
    description: 'Eliminate repetitive manual work with custom workflow automation built around your existing tools and processes.',
        ...
        <div className="container mx-auto px-5 sm:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mb-8">
              Placeholder content — this page is coming soon. We build custom workflow automation systems that eliminate repetitive manual tasks and connect your existing tools into reliable, scalable processes.
            </p>
      ...
      <section className="py-16 lg:py-20 border-b border-border/40">
        <div className="container mx-auto px-5 sm:px-8 max-w-3xl">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            Full page content is being written. This section will cover automation patterns, tool integrations (n8n, Make, Zapier), and the types of workflows we design and implement for growing businesses.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-5 sm:px-8 max-w-2xl">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Every engagement starts with a free diagnostic call. We map your current processes, identify automation opportunities, and give you a fixed-price proposal.
            </p>
            <Link
              href="/contact"
