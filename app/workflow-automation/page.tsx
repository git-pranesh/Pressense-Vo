      ...
      <section>
        <div className="container mx-auto px-5 sm:px-8 py-16 lg:py-20 max-w-5xl">
          <AnchorCard
            ...
            headline="Find out what's eating your team's time"
            body="Start with the diagnostic. We'll show you exactly where the manual work is before recommending anything."
