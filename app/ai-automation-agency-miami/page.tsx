...
export default function AIMiamiPage() {
  ...
  return (<><StructuredData data={schema} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":["LocalBusiness","ProfessionalService"],"name":"Pressense — AI Automation Agency Miami","description":"AI automation consulting for Miami businesses and Florida founder-led companies.","url":"https://www.pressense.co/ai-automation-agency-miami","areaServed":{"@type":"City","name":"Miami"},"serviceType":"AI Automation Consulting","parentOrganization":{"@type":"Organization","name":"Pressense","url":"https://www.pressense.co"}}) }} /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="font-medium mb-6">AI Automation Agency in Miami</h1><p className="text-xl text-muted-foreground mb-8">AI automation for Miami companies.</p></section></main></>)
}
