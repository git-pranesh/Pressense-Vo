...
export default function AIChicagoPage() {
  ...
  return (<><StructuredData data={schema} /><Header /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">AI Automation Agency in Chicago</h1><p className="text-xl text-muted-foreground mb-8">AI automation for Chicago companies.</p></section></main><Footer /></>)
}
