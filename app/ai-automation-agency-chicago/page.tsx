...
export default function AIChicagoPage() {
  ...
  return (<><StructuredData data={schema} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":["LocalBusiness","ProfessionalService"],"name":"Pressense — AI Automation Agency Chicago","description":"AI automation consulting for Chicago businesses and Midwest founder-led companies.","url":"https://www.pressense.co/ai-automation-agency-chicago","areaServed":{"@type":"City","name":"Chicago"},"serviceType":"AI Automation Consulting","parentOrganization":{"@type":"Organization","name":"Pressense","url":"https://www.pressense.co"}}) }} /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">AI Automation Agency in Chicago</h1><p className="text-xl text-muted-foreground mb-8">AI automation for Chicago companies.</p></section></main></>)
}
