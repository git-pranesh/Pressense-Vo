...
export default function StrategyLondonPage() {
  ...
  return (<><StructuredData data={schema} /><Header /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">Business Strategy Consultant in London</h1><p className="text-xl text-muted-foreground mb-8">Strategic consulting for London-based businesses.</p></section></main><Footer /></>)
}
