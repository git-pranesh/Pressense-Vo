...
export default function SystemsBostonPage() {
  ...
  return (<><StructuredData data={schema} /><Header /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">Business Systems Consultant in Boston</h1><p className="text-xl text-muted-foreground mb-8">Operations and systems consulting for Boston companies.</p></section></main><Footer /></>)
}
