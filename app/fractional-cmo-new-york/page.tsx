...
export default function CMONYPage() {
  ...
  return (<><StructuredData data={schema} /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">Fractional CMO in New York</h1><p className="text-xl text-muted-foreground mb-8">Part-time marketing leadership for NYC-based startups.</p></section></main></>)
}
