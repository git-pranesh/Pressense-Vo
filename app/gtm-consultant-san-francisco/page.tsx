...
export default function GTMSFPage() {
  ...
  return (<><StructuredData data={schema} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":["LocalBusiness","ProfessionalService"],"name":"Pressense — GTM Consultant San Francisco","description":"GTM strategy consulting for San Francisco startups and Bay Area founder-led businesses.","url":"https://www.pressense.co/gtm-consultant-san-francisco","areaServed":{"@type":"City","name":"San Francisco"},"serviceType":"GTM Strategy Consulting","parentOrganization":{"@type":"Organization","name":"Pressense","url":"https://www.pressense.co"}}) }} /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="font-medium mb-6">Go-to-Market Strategy Consultant in San Francisco</h1><p className="text-xl text-muted-foreground mb-8">GTM strategy for SF SaaS startups. ICP, positioning, pricing, 90-day roadmap.</p></section></main></>)
}
