...
export default function GTMSFPage() {
  ...
  return (<><StructuredData data={schema} /><Header /><main className="min-h-screen"><section className="max-w-4xl mx-auto px-6 lg:px-10 py-16"><h1 className="text-4xl font-bold mb-6">Go-to-Market Strategy Consultant in San Francisco</h1><p className="text-xl text-muted-foreground mb-8">GTM strategy for SF SaaS startups. ICP, positioning, pricing, 90-day roadmap.</p></section></main><Footer /></>)
}
