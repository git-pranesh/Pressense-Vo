...
const stats = [
  { value: '1 week', label: 'to map the operating gaps' },
  { value: 'HubSpot, Notion', label: 'or custom-built' },
  { value: '0', label: 'software added before the workflow is designed' },
]

export function CrmErpHero() {
  return (
    <section id="hero" className="relative pt-32 pb-20 overflow-hidden" aria-label="CRM and ERP systems">
      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs tracking-[0.2em] uppercase text-primary font-medium">CRM and ERP Systems</span>
          </div>
          ...
          <p className="text-xl sm:text-2xl font-medium text-foreground mb-6">
            We design and build the operating layer that gives your team visibility, ownership, and structure across every stage of the business.
          </p>

          <div className="border-l-2 border-primary/50 pl-5 mb-8">
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
              Most businesses do not need more software. They need a clearer operating system for leads, customers, delivery, finance, reporting, ownership, and follow-up. We map the workflow first, then build the system inside the right tools, whether that is HubSpot, Notion, a custom build, or a combination.
            </p>
          </div>
