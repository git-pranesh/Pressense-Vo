    ...
    <section id="what-we-build" className="py-20 md:py-28 bg-surface">
      <div className="container max-w-5xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-14">
          {contentTypes.map((ct) => (
            <div key={ct.type} className="p-6 rounded-2xl bg-card">
              <div className="flex items-start justify-between gap-4 mb-3">
                <h3 className="text-base font-medium text-foreground">{ct.type}</h3>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="p-6 rounded-2xl border border-primary/30 bg-primary/5">
            <p className="text-sm font-medium text-foreground mb-2">B2B SaaS expertise, not generalist content</p>
          ...
          <div className="p-6 rounded-2xl bg-card">
            <p className="text-sm font-medium text-foreground mb-2">Written for Google and AI citation</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-card">
            <p className="text-sm font-medium text-foreground mb-2">Connected to pipeline, not sessions</p>
