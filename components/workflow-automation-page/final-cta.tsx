    ...
    <section className="py-28 lg:py-36">
      <div className="container mx-auto px-5 sm:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground text-balance mb-6 leading-[1.08]">Stop guessing. Start converting.</h2>
          <p className="text-lg text-muted-foreground mb-12 leading-relaxed text-pretty">Your product works. Your GTM should too. Let us diagnose where it breaks and build a strategy that converts.</p>
