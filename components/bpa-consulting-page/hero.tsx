...
export function BPAHero() {
  return (
    <section id="hero" className="relative pt-32 pb-20 flex flex-col justify-center overflow-hidden pt-20" aria-label="Business Process Automation Consulting">
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            ...
            <Link href="/ai-workflows-automation" className="group inline-flex items-center gap-2 px-9 py-5 rounded-full text-base font-medium border border-border text-foreground hover:border-foreground/40 transition-all duration-200">
