      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            ...
            <Link href="/ai-workflows-automation" className="group inline-flex items-center gap-2 px-9 py-5 rounded-full text-base font-semibold border border-border text-foreground hover:border-foreground/40 transition-all duration-200">
