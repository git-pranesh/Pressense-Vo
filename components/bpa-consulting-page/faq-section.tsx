...
const systemsFAQs = [
  ...
  { question: 'What if we already have tools that are not working?', answer: (<>Common. Most tool problems are actually process problems. We diagnose why current tools are not adopted and either fix the implementation or recommend alternatives. <Link href="/contact" className="text-primary hover:underline">Start with a diagnostic</Link>.</>) },
]
