      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-3 mb-10">
            <div>
              <p className="text-2xl font-medium text-foreground">Three tracks</p>
            ...
            <div>
              <p className="text-2xl font-medium text-foreground">One operator</p>
              <p className="text-xs text-muted-foreground uppercase tracking-wide">not a committee</p>
            </div>
            <div className="w-px bg-border/40 self-stretch" aria-hidden="true" />
            <div>
              <p className="text-2xl font-medium text-foreground">Founder-led</p>
