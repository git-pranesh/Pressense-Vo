...
export function FractionalCMOHero() {
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20" aria-label="Fractional CMO Services">
      <div className="absolute inset-0 grid-bg opacity-60" aria-hidden="true" />
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-2xl mb-8">
            A fractional CMO provides senior marketing leadership to your business part-time, giving you strategic direction, GTM clarity, and marketing systems without the $300K+ annual cost of a full-time hire. Pressense delivers fractional CMO services for founder-led businesses ready to scale.
          </p>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mb-12">
            You need marketing strategy, not another marketing hire who needs direction. Get experienced GTM leadership on a schedule that fits your stage and budget.
          </p>
