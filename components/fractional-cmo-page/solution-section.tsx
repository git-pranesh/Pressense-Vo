      ...
      <div className="container mx-auto px-5 sm:px-8">
        ...
        <div className="max-w-3xl mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="eyebrow">Cost and value comparison</span>
          </div>
          <h2
          ...
          <table className="w-full text-sm" role="table" aria-label="CMO hiring options comparison">
            <thead>
              <tr className="border-b border-border/40 bg-card/40">
                ...
                <th className="px-6 py-4 text-center text-xs font-medium uppercase tracking-widest text-muted-foreground">Full-time CMO</th>
                <th className="px-6 py-4 text-center text-xs font-medium uppercase tracking-widest text-primary bg-primary/5">Fractional CMO</th>
                <th className="px-6 py-4 text-center text-xs font-medium uppercase tracking-widest text-muted-foreground">Marketing Agency</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
