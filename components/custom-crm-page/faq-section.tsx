...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        Custom CRM development starts from $5,000 for a lean MVP for a team of three to ten. Most founder-led businesses land in the $5,000 to $15,000 range. The final cost depends on the number of data objects, integrations, automation rules, and custom reporting required. A three-year comparison with Salesforce or HubSpot Enterprise often shows the custom build is cheaper at scale, because you pay once for the build and own the software outright. All Pressense builds come with a fixed-price estimate after the <Link href="/contact" className="text-primary hover:underline">free diagnostic</Link>.
      </>
    ),
  },
  {
