    ...
    <section id="cta" className="py-28 lg:py-40 relative overflow-hidden" aria-labelledby="final-heading">
      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto">
          <h2 id="final-heading" className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground text-balance mb-6 leading-[1.08]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="/apply" className="group inline-flex items-center gap-3 px-9 py-5 rounded-2xl text-base font-semibold bg-primary text-primary-foreground hover:bg-highlight transition-all duration-200 glow-accent">
            ...
            <a href="/playbooks" className="inline-flex items-center gap-2 px-7 py-5 rounded-2xl text-base font-medium border border-border text-foreground hover:border-primary/50 hover:bg-secondary/40 transition-all duration-200">
              View Playbooks
            </a>
          </div>
        </div>
