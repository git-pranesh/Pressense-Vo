...
const footerColumns = {
  ...
  tools: [
    ...
    { label: 'Internal Tools & Systems', href: '/internal-tools-vs-saas' },
    { label: 'AI Tools We Use', href: '/tools' },
  ],
  resources: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerColumns.locations.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-xs text-muted-foreground hover:text-foreground transition-colors">
                    {link.label}
                  </Link>
        ...
        <div className="border-t border-border/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-semibold tracking-wide">PRESSENSE</span>
          </div>
