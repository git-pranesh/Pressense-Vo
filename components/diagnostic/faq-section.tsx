...
const diagnosticFAQs = [
  {
    question: 'What happens after we submit a diagnostic request?',
    answer: (
      <>
        After you submit, Pressense reviews the context and determines whether a diagnostic conversation makes sense. The goal is to understand the business problem before suggesting a scope, system, or implementation path. Learn more about{' '}
        <Link href="/how-it-works" className="text-primary hover:underline">how the diagnostic process works</Link>.
      </>
    ),
  },
  {
    question: 'Who should start a diagnostic?',
    answer: (
      <>
  ...
  {
    question: 'What should we share in the diagnostic request?',
    answer: (
      <>
  ...
  },
  {
    ...
    answer: (
      <>
        The diagnostic request should lead into a diagnostic conversation, not a generic sales call. The purpose is to understand whether Pressense can help and what kind of engagement would make sense.
      </>
    ),
  },
  {
...
export function DiagnosticFAQSection() {
  return (
    <FAQSection
      headline="Questions before starting a diagnostic"
      faqs={diagnosticFAQs}
    />
  )
}
