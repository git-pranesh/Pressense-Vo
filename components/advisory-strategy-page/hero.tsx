...
const stats = [
  { value: '1 week', label: 'to identify the real constraint' },
  { value: '90-day', label: 'execution roadmap delivered' },
  { value: '0', label: 'slide decks without an action plan' },
]

export function AdvisoryStrategyHero() {
  return (
    <section id="hero" className="relative pt-32 pb-20 overflow-hidden" aria-label="Advisory and strategy consulting">
      ...
      <div className="container mx-auto px-5 sm:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs tracking-[0.2em] uppercase text-primary font-medium">Advisory and Strategy</span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tight text-foreground text-balance leading-[1.1] mb-4">
            Advisory and Strategy for Founder-Led Businesses
          </h1>

          <p className="text-xl sm:text-2xl font-medium text-foreground mb-6">
            We identify the real constraint before you spend more on marketing, hiring, tools, or execution.
          </p>

          <div className="border-l-2 border-primary/50 pl-5 mb-8">
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
              Strategic advisory helps founders clarify priorities, sharpen decisions, and define a practical path forward. The output is not a report. It is a clear direction and a sequenced execution plan your team can act on.
            </p>
          </div>
